...
$sql = "SELECT PK_Id, FK_VehicleId, Odometer, FuelType, FuelPrice, TotalPurchase, PurchaseDate FROM TBL_Fuel WHERE FK_VehicleId = 1 ORDER BY PurchaseDate DESC LIMIT 4";
...
if ($result->num_rows > 0) {
    ...
    } echo '<div class="pull-right"> <a href="#" style="text-decoration:none;"><i class="fa fa-caret-right"></i> Ver más </a></div>';
} else {
